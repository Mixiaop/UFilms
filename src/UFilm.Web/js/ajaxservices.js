//Generated by U.FakeMvc.UI.AjaxProGeneratePageBase：20161220152144
...
Object.extend(MoviesService_class.prototype, Object.extend(new AjaxPro.AjaxClass(), {
	QueryLastActivityMovies: function(pageIndex, pageSize, keywords, movieTypes, movieAreas) {
		return this.invoke("QueryLastActivityMovies", {"pageIndex":pageIndex, "pageSize":pageSize, "keywords":keywords, "movieTypes":movieTypes, "movieAreas":movieAreas}, this.QueryLastActivityMovies.getArguments().slice(5));
	},
	Get: function(movieId) {
		return this.invoke("Get", {"movieId":movieId}, this.Get.getArguments().slice(1));
	},
	url: '/ajaxpro/UFilm.Web.Controllers.MovieAjaxController,UFilm.Web.ashx'
}));
