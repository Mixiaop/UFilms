			                            ...
			                            for (i = 0; i < arr.length; i++) {
			                                ...
			                                if (me.thumbnail == true) {
			                                    ...
			                                    if (arr[i].thumbnail != undefined) {
			                                        style = ' style="background:url(' + arr[i].thumbnail + ') no-repeat;"';
			                                    }
			                                ...
			                                //console.log(arr.data[i].data.replace(new RegExp('(' + me.textField.val() + ')', 'gi'), "<b>$1</b>"));
			                                //alert(1);
			                                html += '<div id="' + suggestRow + (i + 1) + '" class="' + cssClass + '"' + id_field + ' seq_id="' + i + '" >' + thumb + '<div class="suggestion_title" relID="' + arr[i].id + '">' + arr[i].data.replace(new RegExp('(' + me.textField.val() + ')', 'gi'), "<b>$1</b>") + '</div>' + desc + '</div>';
			                            }
			                            //console.log(html);
			                            me.holder.html(html);
