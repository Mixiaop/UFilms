<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="UFilm.Console.Adults.Actors.Edit" %>
    ...
    <form runat="server">
        ...
        <div class="content bg-gray-lighter">
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">编辑影人 <small></small>
                    </h1>
                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-horizontal push-10-t">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material">
                                            <asp:TextBox runat="server" ID="tbMovieCount"  CssClass="form-control"></asp:TextBox>
                                            <label>影片数</label>
                                        </div>
                                        <div class="help-block">
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <asp:Button runat="server" ID="btnSave" CssClass="btn btn-primary" Text="保存" /> <a href="<%= GetBackUrlDecoded("List.aspx") %>" class="btn btn-default" >返回</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script>
        ...
        //avatar
        var defaultThumbUrl = $('#<%= hfPictureThumb.ClientID%>').val();
        
        if (defaultThumbUrl != '') {
            $('#thumbPicture').html('<img src="' + defaultThumbUrl + '" />');
        }
