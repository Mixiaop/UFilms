//Generated by U.FakeMvc.UI.AjaxProGeneratePageBase：20170112164129
...
CommonService_class = function() {};
Object.extend(CommonService_class.prototype, Object.extend(new AjaxPro.AjaxClass(), {
	QueryHotMovies: function(keywords, pageIndex, pageSize) {
		return this.invoke("QueryHotMovies", {"keywords":keywords, "pageIndex":pageIndex, "pageSize":pageSize}, this.QueryHotMovies.getArguments().slice(3));
	},
	url: '/ajaxpro/UFilm.AlibWeb.Controllers.Ajax.CommonAjaxController,UFilm.AlibWeb.ashx'
}));
CommonService = new CommonService_class();
