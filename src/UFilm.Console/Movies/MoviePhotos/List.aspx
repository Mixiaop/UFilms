<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/UZero.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="UFilm.Console.Movies.MoviePhotos.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="content bg-gray-lighter">
        <div class="row items-push">
            <div class="col-sm-8">
                <h1 class="page-heading">影片的剧照及海报 <small>所有的影片的图片都在这里</small>
                </h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-xs-12">
                <div class="form-inline">
                    <div class="form-group">
                        <input type="text" id="tbSearchKeywords" placeholder="影片名称、别名" class="form-control" value="<%= Model.GetKeywords %>" />
        ...
        <div class="row items-push" id="photosContainer">
            ...
            <div class="col-xs-6 col-sm-6 col-md-3 col-lg-2 animated fadeIn">
                <div class="img-container">
                    <img class="img-responsive" src="<%= photo.Picture.ThumbUrl %>" alt="<%= photo.Movie.CnName %> 的<%= photo.PhotoType.ToAlias() %>" >
                    <div class="img-options">
                        <div class="img-options-content">
                            <h3 class="font-w400 text-white push-5"><%= photo.Movie.CnName %>的<%= photo.PhotoType.ToAlias() %></h3>
    ...
    <script>
        $(function () {
            ...
            $btnRemovePhotos.click(function () {
                ...
                if (confirm('你确认删除吗?')) {
                    Movies.MovieService.DeletePhoto(photoId, function (res) {
